        ...
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
          {Object.entries(grouped).sort().map(([weekKey, weekItems]) => (
            <div key={weekKey} style={{ marginBottom: '3rem' }}>
              <h3 style={{ color: '#1E7B45', fontSize: '0.9rem', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '1px', marginBottom: '1.5rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
